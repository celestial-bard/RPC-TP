...
def attack_write(
    ...
    data_root = Path("/data/zyq/av2")
    processed = 'processed'
    cached_split = 'val'

    dataset = Av2Dataset(data_root=data_root / processed, cached_split=cached_split)
    root_benign = Path('/data/zyq/av2')
    root_attack = Path('/data/zyq/av2_attacked')
    mode = 'val'
...
if __name__ == '__main__':
    REC_CKPT = r'ckpts/seita_rec.ckpt'
    GEN_CKPT = r'ckpts/seita_gen.ckpt'
    CON_CKPT = r'ckpts/seita_con.ckpt'
