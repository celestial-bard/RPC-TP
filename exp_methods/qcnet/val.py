...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/data/zyq/av2_attacked')
    ...
    parser.add_argument('--ckpt_path', type=str, default='/data/zyq/seita/exp_methods/checkpoints/QCNet_AV2.ckpt')
