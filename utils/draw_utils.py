...
_PLOT_BOUNDS_BUFFER_W: Final[float] = 42
_PLOT_BOUNDS_BUFFER_H: Final[float] = 42
...
def visualize_scenario(
    ...
    plt.axis("equal")
    plt.xlim(
        plot_bounds[0] - _PLOT_BOUNDS_BUFFER_W + bias_x, plot_bounds[0] + _PLOT_BOUNDS_BUFFER_W + bias_x
    )
    plt.ylim(
        plot_bounds[1] - _PLOT_BOUNDS_BUFFER_H + bias_y, plot_bounds[1] + _PLOT_BOUNDS_BUFFER_H + bias_y
    )
    plt.tight_layout()
